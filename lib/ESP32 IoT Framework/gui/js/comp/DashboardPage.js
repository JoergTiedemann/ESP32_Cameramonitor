...
export function DashboardPage(props) {
    ...
    useEffect(() => {
        ...
        //</img>const picture = <img src="http://192.168.178.109/api/getpicture" id="photo" >;
    ...
    const picurl = `${props.API}/api/getpicture`;
    const vidurl = `${props.API}/stream`;
    //console.log("Picurl:",picurl);
    const pictu = <img src={picurl} id="photo"/>;
    const vide = <img width="640" height="480" src={vidurl} id="livevideo"/>;
